 ...
 * 11/02/2022
 * Assignment 8
 * Write a program that obtains the execution time of selection sort, merge
 * sort, quick sort, heap sort, and radix sort for input sizes of 50,000,
 * 100,000, 150,000, 200,000, 250,000, and 300,000.
 * The program creates data randomly and print a table including execution
...
public class FindExecutionTimes {
    public static void main(String[] args) {
        System.out.println("Array size  |  Selection      Merge      Quick " +
                           "      Heap      Radix");
        System.out.println("-----------------------------------------------" +
                           "---------------------");
